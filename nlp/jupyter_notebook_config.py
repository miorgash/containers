...
#  Default: ''
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$xfVcQSdgcS8y16kdXpOusw$OenvjnQtYmtgIbxLMsVxIg'
...
#  Choices: any of ['md5', 'sha3_512', 'sha224', 'sha384', 'blake2s', 'sha3_224', 'sha512', 'sha256', 'sha1', 'blake2b', 'sha3_384', 'sha3_256']
#  Default: 'sha256'
